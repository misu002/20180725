...
<head>
    ...
    <script>
        ...
        function consentForm() {
            if ($('#mendation1').prop("checked") && $('#mendation2').prop("checked")) {
                alert('회원가입을 진행하겠습니다.');
                return true;
            } else {
                alert('필수 항목에 모두 동의하셔야합니다.');
                return false;
            }
        }
    </script>
...
<body>
    <div id="page">
        ...
        <div id="content">
            ...
            <h4><input type="checkbox" id="mendation1">네이버 이용약관 동의<span class="mendate">(필수)</span> </h4>
            <textarea rows="6" cols="60" onclick="changeBor();">여러분을 환영합니다.
...
네이버 서비스와 관련하여 궁금하신 사항이 있으시면 고객센터(대표번호: 1588 – 3820/ 평일 09:00~18:00)로 문의 주시기 바랍니다.</textarea>
            <h4><input type="checkbox" id="mendation2">개인정보 수집 및 이용에 대한 안내<span class="mendate">(필수)</span> </h4>
            <textarea rows="6" cols="60" onclick="changeBor();">정보통신망법 규정에 따라 네이버에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.
...
로그인 기록: 3개월</textarea>
            ...
            <h4><input type="checkbox">위치정보 이용약관 동의<span class="choice">(선택)</span> </h4>
            <textarea rows="6" cols="60" onclick="changeBor();">위치정보 이용약관에 동의하시면, 위치를 활용한 광고 정보 수신 등을 포함하는 네이버 위치기반 서비스를 이용할 수 있습니다.
...
이메일 주소 : privacy@naver.com</textarea>
            ...
            <h4><input type="checkbox">이벤트 등 프로모션 알림 메일 수신<span class="choice">(선택)</span> </h4>

            <form action="/NaverRegister.jsp" onsubmit="return consentForm();">
                <button id="notconsent">비동의</button> <button id="consent" type="submit">동의</button>
            </form>
