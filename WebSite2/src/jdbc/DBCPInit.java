...
public class DBCPInit extends HttpServlet{ //다 만들고서 web.xml 등록 안하면 소용없음
	...
	private void initConnectionPool() {
		...
		GenericObjectPool<PoolableConnection> connectionPool =
				...
				driver.registerPool("pool1", connectionPool);
				System.out.println("pool1의 이름으로 커넥션 풀 등록 성공");
				}catch (Exception e) {
